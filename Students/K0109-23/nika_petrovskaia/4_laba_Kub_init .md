# Структура отчета: 
	## 1) Вывод консоли
	## 2) Контрольные ответы

# 1. Вывод консоли
1. `kubectl get nodes` — все "ready"
main@nika:/mnt/c/Users/main$ kubectl get nodes
NAME       STATUS   ROLES           AGE   VERSION
minikube   Ready    control-plane   2d    v1.35.1
main@nika:/mnt/c/Users/main$

2. `kubectl get pods -n kube-system` — все системные поды Running 
main@nika:/mnt/c/Users/main$ kubectl get pods -n kube-system
...
main@nika:/mnt/c/Users/main$ kubectl get pods
NAME           READY   STATUS    RESTARTS        AGE
...
main@nika:/mnt/c/Users/main$ kubectl get pod my-webserver
NAME           READY   STATUS    RESTARTS        AGE
...
# 2. Контрольные ответы:
	1. Какие поды в kube-system всегда должны быть Running?
		Такие как: coredns (DNS), etcd (база данных), kube-apiserver (мозг кластера), kube-controller-manager, kube-scheduler, kube-proxy (сеть).
